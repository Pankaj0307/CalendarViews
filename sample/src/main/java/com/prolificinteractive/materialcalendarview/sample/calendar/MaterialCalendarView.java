package com.prolificinteractive.materialcalendarview.sample.calendar;
...
public class MaterialCalendarView extends ViewGroup {
  ...
  public MaterialCalendarView(Context context, AttributeSet attrs) {
    ...
    final View content = inflater.inflate(com.prolificinteractive.materialcalendarview.R.layout.calendar_view, null, false);

    topbar = content.findViewById(com.prolificinteractive.materialcalendarview.R.id.header);
    buttonPast = content.findViewById(com.prolificinteractive.materialcalendarview.R.id.previous);
    title = content.findViewById(com.prolificinteractive.materialcalendarview.R.id.month_name);
    buttonFuture = content.findViewById(com.prolificinteractive.materialcalendarview.R.id.next);
